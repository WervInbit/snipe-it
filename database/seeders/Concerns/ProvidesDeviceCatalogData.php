...
trait ProvidesDeviceCatalogData
{
    ...
    protected function attributeBlueprints(): array
    {
        $blueprints = [
            ...
            'camera_ois' => [
                'label' => 'Optische beeldstabilisatie',
                'datatype' => AttributeDefinition::DATATYPE_BOOL,
                'categories' => ['Camera'],
            ],
            'port_connector_type' => [
            ...
            'bluetooth_version' => [
                'label' => 'Bluetooth-versie',
                'datatype' => AttributeDefinition::DATATYPE_ENUM,
                'categories' => ['Network'],
                'options' => [
                    ['value' => '4.0', 'label' => 'Bluetooth 4.0'],
                    ['value' => '4.1', 'label' => 'Bluetooth 4.1'],
                    ...
                    ['value' => '6.0', 'label' => 'Bluetooth 6.0'],
                    ['value' => '6.1', 'label' => 'Bluetooth 6.1'],
                ],
                'allow_custom_values' => true,
            ],
            'nfc' => [
