...
const outDir = 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-initial-guides-v2';
...
class SvgDoc {
  ...
  doneBox(textValue, related = []) {
    ...
    this.text(12, 294, `Bron: bestaande screenshots + snipe.inbit waar beschikbaar | Initial guides v2 | ${today}`, { size: 1.65, fill: colors.muted });
...
function renderAc01() {
  ...
  doc.context([
    ...
    { label: 'Adres', value: 'https://snipe.inbit/', size: 2.7 },
  ]);
...
function renderHelp01() {
  const doc = makeDoc('HELP-01', 'Problemen', 'Stop, herstel of vraag hulp zonder gegevens verkeerd te wijzigen', 'HELP');
  doc.header();
  doc.context([
    { label: 'Rol', value: 'Iedereen' },
...
const currentStandaloneGuides = [
  {
    name: 'AC-01-login-snipe-v5',
    pdf: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-ac01-snipe-login\\AC-01-login-snipe-v5-proof.pdf',
    png: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-ac01-snipe-login\\AC-01-login-snipe-v5-proof.png',
    svg: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-ac01-snipe-login\\AC-01-login-snipe-v5.svg',
  },
  {
    name: 'SC-01-scan-asset-snipe-v6',
    pdf: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-sc01-snipe-scan\\SC-01-scan-asset-snipe-v6-proof.pdf',
    png: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-sc01-snipe-scan\\SC-01-scan-asset-snipe-v6-proof.png',
    svg: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-07-07-sc01-snipe-scan\\SC-01-scan-asset-snipe-v6.svg',
  },
  {
    name: 'AST-01-open-asset-clean-v12',
    pdf: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-06-30-ast01-clean-open-asset\\AST-01-open-asset-clean-v12-proof.pdf',
    png: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-06-30-ast01-clean-open-asset\\AST-01-open-asset-clean-v12-proof.png',
    svg: 'C:\\Users\\Gebruiker\\Documents\\snipe-it manuals\\layout-proofs\\2026-06-30-ast01-clean-open-asset\\AST-01-open-asset-clean-v12.svg',
  },
];

const pages = [
  ['AST-02-existing-asset-refurbishment-front-v2', renderAst02Front()],
  ['AST-02-existing-asset-refurbishment-back-v2', renderAst02Back()],
  ['WF-01-start-workflow-v2', renderWf01()],
  ['WF-02-complete-workflow-v2', renderWf02()],
  ['CMP-04-remove-component-to-tray-v2', renderCmp04()],
  ['HELP-01-common-problems-v2', renderHelp01()],
];
...
<head>
<meta charset="utf-8">
<title>Initial operator guides v2</title>
<style>
  @page { size: A4 portrait; margin: 0; }
  html, body { margin: 0; padding: 0; background: #2f3338; }
...
const combinedHtmlPath = path.join(outDir, 'initial-guides-v2-remaining.html');
const combinedPdfPath = path.join(outDir, 'initial-guides-v2-remaining-proof.pdf');
const contactHtmlPath = path.join(outDir, 'initial-guides-v2-contact-sheet.html');
const contactPngPath = path.join(outDir, 'initial-guides-v2-contact-sheet.png');
...
const summaryPath = path.join(outDir, 'initial-guides-v2-summary.md');
const summary = [
  '# Initial Operator Guide Drafts v2',
  '',
  `Generated: ${today}`,
  '',
  '## Current Standalone Guides',
  '',
  ...currentStandaloneGuides.map((item) => `- ${item.name}: PDF ${item.pdf}`),
  '',
  '## Outputs',
  '',
  ...outputs.map((item) => `- ${item.name}: PDF ${item.pdf}`),
  '',
  `- Combined remaining-guides PDF: ${combinedPdfPath}`,
  ...
  '## Source Notes',
  '',
  '- AC-01, SC-01, and AST-01 use the focused standalone proofs listed above.',
  '- Remaining guide pages use available screenshots from the 2026-06-25, 2026-06-30, and 2026-07-02 capture sets.',
