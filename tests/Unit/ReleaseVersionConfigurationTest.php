...
{
    public function test_post_v1_development_version_does_not_impersonate_a_release_artifact(): void
    {
        $version = require __DIR__.'/../../config/version.php';

        $this->assertSame('v1.1.0-dev', $version['app_version']);
        ...
        $this->assertStringContainsString('post-V1 worktree', $version['full_app_version']);
