    ...
    <div class="list clearfix">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="admin box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.workflow-profiles.index') }}" class="settings_button">
                  <x-icon type="tasks" class="fa-4x"/>
                  <br><br>
                  <span class="name">{{ __('Workflow Profiles') }}</span>
                  <span class="keywords" aria-hidden="true" style="display:none">{{ trans('admin/settings/general.keywords.test_settings') }}</span>
                </a>
              </h5>
              <p class="index-block">{{ __('Build selectable workflows and manage sale-readiness blocking profiles.') }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="admin box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.testtypes.index') }}" class="settings_button">
                  <x-icon type="tests" class="fa-4x"/>
                  <br><br>
                  <span class="name">{{ __('Workflow Items') }}</span>
                  <span class="keywords" aria-hidden="true" style="display:none">{{ trans('admin/settings/general.keywords.test_settings') }}</span>
                </a>
              </h5>
              <p class="index-block">{{ __('Define reusable tests and tasks, including applicability and default result buttons.') }}</p>
            </div>
          </div>
        </div>
