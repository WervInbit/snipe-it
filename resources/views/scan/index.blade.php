...
<div class="container text-center">
    ...
    <video id="scan-video" class="w-100" style="max-width:400px;height:auto;border:1px solid #ccc;" autoplay muted playsinline></video>
    ...
    <div class="mt-2">
        <button id="scan-start" class="btn btn-primary">{{ __('Start') }}</button>
        <button id="scan-stop" class="btn btn-secondary">{{ __('Stop') }}</button>
    </div>

    <form id="scan-manual" class="mt-3">
        <input id="asset-tag" type="text" class="form-control" placeholder="{{ __('Enter asset tag') }}">
        <button type="submit" class="btn btn-primary mt-2">{{ __('Go') }}</button>
    </form>
