    ...
    <label for="asset_tag" class="col-md-3 control-label">{{ trans('admin/hardware/form.tag') }}</label>
      ...
      @else
          ...
          <div class="col-md-7 col-sm-8">
              <input class="form-control js-asset-tag-input" type="text" name="asset_tags[1]" id="asset_tag" value="{{ old('asset_tags.1', \App\Models\Asset::generateTag()) }}" readonly>
              {!! $errors->first('asset_tags', '<span class="alert-msg"><i class="fas fa-times"></i> :message</span>') !!}
              {!! $errors->first('asset_tag', '<span class="alert-msg"><i class="fas fa-times"></i> :message</span>') !!}
          </div>
          <div class="col-md-2 col-sm-4">
              <button type="button" class="btn btn-default btn-block js-asset-tag-unlock">Unlock</button>
          </div>
      @endif
  </div>
...
<script nonce="{{ csrf_token() }}">
    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            var raw_tag = String($("#asset_tag").val() || '').replace(/^{{ preg_quote(App\Models\Setting::getSettings()->auto_increment_prefix, '/') }}/g, '');
            ...
            if (x < max_fields) {
                ...
                box_html += '<div class="col-md-7 col-sm-12">';
                box_html += '<input type="text" class="form-control js-serial-input" name="serials[' + x + ']">';
                box_html += '</div>';
