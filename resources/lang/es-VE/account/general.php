...
return array(
    ...
    'api_reference' => 'Consulte <a href=":fork_documentation_url" target="_blank">API reference</a> para encontrar los puntos finales (endpoins) de la API y documentación adicional.',
