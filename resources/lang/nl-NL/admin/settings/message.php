...
return [
    ...
    'backup' => [
        ...
        'invalid_archive'       => 'Dit back-uparchief is ongeldig of bevat niet precies één niet-lege SQL-dump.',
        'restore_backup_failed' => 'De veiligheidsback-up is mislukt. Het herstel is niet gestart.',
        'restore_disabled'      => 'Herstellen vanuit een geüploade back-up is uitgeschakeld. Gebruik in plaats daarvan de beoordeelde herstelprocedure voor beheerders.',
    ...
    'webhook' => [
        ...
        'error_safe' => 'Er ging iets mis bij het verbinden met :app. Controleer het eindpunt en de applicatielogboeken voor details.',
