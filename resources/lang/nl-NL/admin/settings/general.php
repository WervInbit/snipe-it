...
return [
    ...
    'ldap_runtime_disabled'     => 'LDAP is uitgeschakeld voor deze omgeving en is niet gevalideerd voor V1. Lokale accounts blijven beschikbaar. Er wordt geen verbinding met een directory gemaakt.',
...
'ldap_location_help'             => 'Het Ldap Locatie veld moet worden gebruikt als <strong>een OU niet gebruikt wordt in de Base Bind DN.</strong> Laat dit leeg als er een OU zoekopdracht wordt gebruikt.',
    ...
    'ldap_activated_flag_help'  => 'Deze waarde bepaalt of een gesynchroniseerde gebruiker kan inloggen op deze applicatie. <strong>Dit heeft geen invloed op de mogelijkheid om items aan de gebruiker uit te geven of in te nemen</strong>. Vul de <strong>attribuutnaam</strong> uit AD/LDAP in, <strong>niet de waarde</strong>. <br><br>Als het attribuut niet bestaat of de waarde <code>0</code> of <code>false</code> is, wordt inloggen uitgeschakeld. Bij <code>1</code>, <code>true</code> of andere tekst kan de gebruiker inloggen. Als het veld leeg is, wordt het attribuut <code>userAccountControl</code> gevolgd.',
    ...
    'load_remote_help_text'		=> 'Schakel dit uit als uw installatie geen scripts van het internet kan laden. Zo probeert de applicatie geen avatars van Gravatar of andere externe bronnen te laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Als hier een URL wordt opgegeven, worden gebruikers ernaartoe doorgestuurd nadat zij zich bij deze applicatie hebben afgemeld. Hiermee kan de sessie bij de authenticatieprovider correct worden gesloten.',
    ...
    'show_images_in_email_help'   => 'Schakel dit uit als deze installatie zich achter een VPN of gesloten netwerk bevindt en ontvangers buiten dat netwerk de afbeeldingen in e-mails niet kunnen laden.',
    'site_name'                 => 'Site naam',
    ...
    'snipe_version'  			=> 'Applicatieversie',
    'support_footer'            => 'Ondersteuningsvoettekst links ',
    'support_footer_help'       => 'Geef aan wie de links naar ondersteuningsinformatie en de gebruikershandleiding ziet',
    'version_footer'            => 'Versie in voettekst ',
    'version_footer_help'       => 'Geef aan wie de applicatieversie en het buildnummer ziet.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link naar deze applicatie in e-mails',
    'show_url_in_emails_help_text'      => 'Schakel dit uit als e-mailvoetteksten niet naar deze applicatie mogen verwijzen. Dit is handig als de meeste ontvangers nooit inloggen.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Hiermee worden gecachte barcodes verwijderd. Dit wordt meestal gebruikt nadat de barcode-instellingen of de applicatie-URL zijn gewijzigd. Barcodes worden opnieuw gegenereerd wanneer ze weer worden geopend.',
