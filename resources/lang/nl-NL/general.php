...
return [
    ...
    'download_qr_label'     => 'Download QR-label',
    ...
    'error'				    => 'Foutmelding',
    'error_location_parent_company' => 'Bovenliggende locatie ":parent" hoort bij :parent_company, maar deze locatie hoort bij :location_company.',
    ...
    'image_filetypes_help'  => 'Geaccepteerde bestandstypen zijn jpg, png, gif en svg. De maximale toegestane bestandsgrootte is :size.',
    'unaccepted_image_type'  => 'Dit afbeeldingsbestand is niet leesbaar. Geaccepteerde bestandstypen zijn jpg, png, gif en svg. Het MIME-type van dit bestand is: :mimetype.',
    'import'         	    => 'Importeer',
    'import_this_file'      => 'Kaart velden en verwerk dit bestand',
    'importing'         	=> 'Importeren',
    'importing_help'        => 'U kunt assets, accessoires, licenties, componenten, verbruiksartikelen en gebruikers importeren via het CSV-bestand. <br><br>De CSV moet door komma\'s worden gescheiden en met koppen die overeenkomen met de koppen in de <a href=":fork_documentation_url" target="_new">voorbeeld CSV\'s in de documentatie</a>.',
    ...
    'attach_photo'           => 'Foto toevoegen',
    'replace_photo'          => 'Foto vervangen',
    'photo_added'            => 'Foto toegevoegd',
    'scan'                   => 'Scannen',
    'scan_qr'                => 'Scan QR',
    'manage_portal'          => 'Beheer',
    'scan_camera_denied'     => 'Cameratoegang geweigerd. Gebruik handmatig zoeken.',
    'scan_hint_move_closer'  => 'Houd de hele code binnen het kader. Is het beeld onscherp, beweeg de camera dan langzaam naar achteren.',
    'quality_grade'          => 'Kwaliteit',
    'quality_grade_unset'    => 'Selecteer kwaliteit',
    'quality_grade_a'        => 'Kwaliteit A',
    'quality_grade_b'        => 'Kwaliteit B',
    'quality_grade_c'        => 'Kwaliteit C',
    'quality_grade_d'        => 'Kwaliteit D',
    'scan_switch_camera'     => 'Schakel camera',
    'scan_refocus'           => 'Stel scherp',
    'scan_torch'             => 'Zaklamp',
    'scan_manual_entry'      => 'Handmatige invoer',
    'scan_manual_placeholder'=> 'Voer assettag, componenttag of serienummer in',
    ...
    'being_refurbished'         => 'In bewerking',
    'broken_spare_parts'        => 'Defect/Onderdelen',
    ...
    'webhook_test_msg'        => 'Het lijkt erop dat uw :app-integratie met dit platform werkt!',
    ...
    'model_resources'            => 'Modelbronnen',
    'model_resources_help'       => 'Deze privébestanden horen bij model :model en worden gedeeld door alle apparaten van dit model. Gebruik Bestanden voor documenten die alleen bij dit apparaat horen.',
...
// Add form placeholders here
    ...
    'months_plural' => '1 maand|:count maanden',
    ...
    'qr_preview_for' => 'QR-voorbeeld voor :asset',
    'qr_template_hint' => 'Kies het labelformaat dat past bij de rol in de Dymo LabelWriter voordat je print of downloadt.',
    'bulk_qr_template_hint' => 'Alleen gebruikt bij de bulkactie QR-codes genereren.',
    'qr_printed_on_date' => 'QR geprint op :date',
    'generate_qrs' => 'QR-codes genereren',
    'image_upload_failed' => 'Afbeelding uploaden mislukt.',
    'image_deleted' => 'Afbeelding verwijderd.',
    'image_delete_failed' => 'Afbeelding verwijderen mislukt.',
    'image_caption_updated' => 'Bijschrift bijgewerkt.',
    'too_many_asset_images' => 'Assets mogen maximaal 30 afbeeldingen hebben.',
    'images' => 'Afbeeldingen',
    'caption' => 'Bijschrift',
    'caption_required' => 'Voer voor elke afbeelding een bijschrift in.',
    'drag_n_drop_help' => 'Sleep afbeeldingen hierheen of klik om te bladeren.',
    'cover_image_notice' => 'De eerste geuploade afbeelding wordt als coverfoto gebruikt.',
    'public_gallery_notice' => 'Openbare galerij: deze afbeeldingen kunnen op openbare pagina\'s en in de webshop verschijnen. Upload hier geen workflowbewijs, wachtwoorden, herstelcodes of klant-/reparatiegegevens.',
    'private_attachment_notice' => 'Privébijlage: toegang wordt met rechten beheerd, maar dit is geen wachtwoordkluis. Sla hier nooit wachtwoorden, herstelcodes of klant-/reparatiegegevens op.',
    'invalid_image_type' => 'Alleen JPG-, PNG- of GIF-afbeeldingen zijn toegestaan.',
    'image_too_large' => 'Afbeeldingen mogen niet groter zijn dan :size.',
    'no_asset_images' => 'Geen afbeeldingen geupload voor dit asset.',
    'select_sku' => 'Selecteer een SKU',
    'password' => 'Wachtwoord',
    'open_new_window' => 'Open dit bestand in een nieuw venster',
    'login_disabled' => 'Login uitgeschakeld',
    'show_admins' => 'Admin-gebruikers',
    'show_superadmins' => 'Superusers',
    'use_cloned_image' => 'Afbeelding van origineel klonen',
    'use_cloned_image_help' => 'Je kunt de originele afbeelding klonen of hieronder een nieuwe uploaden.',
    'use_cloned_no_image_help' => 'Dit item heeft geen eigen afbeelding en gebruikt de afbeelding van het model of de categorie. Upload hieronder een nieuwe afbeelding als je een specifieke afbeelding wilt gebruiken.',
    'see_note' => 'zie notitie',
    'test_run_created' => 'Testrun aangemaakt',
    'none' => 'Geen',
    'na' => 'N.v.t.',
    'tag' => 'Tag',
    'condition' => 'Conditie',
    ...
    'more' => 'Meer',
    'camera' => 'Camera',
    'session_expiring_title' => 'Sessie verloopt bijna',
    ...
    'scan_asset_or_component_help' => 'Richt de camera op een assettag of component-QR-label om de detailpagina te openen.',
    'scan_refresh_camera' => 'Camera vernieuwen',
    'scan_request_camera_access' => 'Cameratoegang vragen',
    'scan_select_camera' => 'Camera selecteren',
    'scan_camera_access_failed' => 'Geen toegang tot camera',
    'scan_camera_unavailable' => 'Camera niet beschikbaar',
    'scan_camera_busy' => 'De camera wordt al door een andere toepassing gebruikt.',
    'scan_camera_permission_help' => 'Sta cameratoegang toe en probeer opnieuw, of zoek handmatig.',
    'scan_retry_camera' => 'Camera opnieuw proberen',
    'scan_manual_help' => 'Zoek op exacte assettag, zichtbare componenttag, component-QR-waarde of serienummer van het asset.',
    'scan_manual_required' => 'Voer een assettag, componenttag, QR-waarde of serienummer in.',
    'scan_status_starting' => 'Camera starten...',
    'scan_status_scanning' => 'Camera gereed. Houd de code stil binnen het kader.',
    'scan_status_no_code' => 'Nog geen code gevonden. Houd de hele code in beeld; is deze onscherp, beweeg de camera dan langzaam naar achteren.',
    'scan_status_retrying' => 'Camera opnieuw starten...',
    'scan_status_refocusing' => 'Camera opnieuw scherpstellen...',
    'scan_status_success' => 'Code gevonden. Record openen...',
    'scan_status_paused' => 'Camera gepauzeerd. Probeer opnieuw wanneer je klaar bent.',
    'scan_navigation_failed' => 'Het record is niet geopend. Probeer de camera opnieuw of zoek handmatig.',
    'printer_location' => 'Printerlocatie',
    'label_sent_to_printer' => 'Label naar printer gestuurd.',
    'printing_failed' => 'Printen mislukt.',
    'add_serial' => 'Serienummer toevoegen',
    'change_serial' => 'Serienummer wijzigen',
    'save_serial' => 'Serienummer opslaan',
    'component_serial_locked_help' => 'Serienummer is standaard vergrendeld. Gebruik de knop om het serienummer vast te leggen of te corrigeren.',
    'component_serial_change_confirm' => 'Dit component heeft al een serienummer. Weet je zeker dat je dit wilt wijzigen?',
    'component_serial_change_required' => 'Bevestig dat je het bestaande serienummer wilt wijzigen.',
    'component_serial_unlock_required' => 'Ontgrendel het serienummerveld voordat je opslaat.',
    'component_serial_updated' => 'Serienummer van component bijgewerkt.',
    'move_component_to_other_device' => 'Component naar ander apparaat verplaatsen',
    'move_to_other_device' => 'Naar ander apparaat',
    'scan_destination_asset' => 'Scan doelasset',
    'scan_destination_asset_help' => 'Scan het QR-label van het doelasset om het verplaatsformulier hieronder vooraf in te vullen. Je kunt het doel ook handmatig kiezen.',
    'expected_component_transfer_help' => 'Dit verwachte component wordt als gevolgd onderdeel aangemaakt en direct naar het doelasset verplaatst.',
    'expected_component_attention_warning' => 'Dit verwachte component blijft op aandacht nodig staan totdat het is gecontroleerd. Bevestig de waarschuwing voordat je het verplaatst.',
    'confirm_condition_warning_move' => 'Ik begrijp deze conditiewaarschuwing en wil het verplaatsen.',
    'confirm_lifecycle_warning_move' => 'Ik begrijp deze lifecycle-waarschuwing en wil het verplaatsen.',
    'destination_asset' => 'Doelasset',
    'search_assets' => 'Assets zoeken',
    'to_tray' => 'Naar tray',
    'to_storage' => 'Naar opslag',
    'to_stock' => 'Naar voorraad',
    'move_within_device' => 'Binnen apparaat verplaatsen',
    'my_tray' => 'Mijn tray',
    'tray' => 'Tray',
    'register_component' => 'Component registreren',
    'register_loose_component' => 'Los component registreren',
    'register_loose_component_help' => 'Gebruik dit formulier alleen voor handmatige voorraadintake. Gebruik voor verwijderingen uit een asset het tabblad Componenten.',
    'tray_workspace' => 'Tray werkruimte',
    'tray_workspace_help' => 'Bekijk wat er nu in je tray staat en start daarna de volgende workflow vanuit de rijacties.',
    'no_components_in_tray' => 'Er zijn geen componenten aan je tray toegewezen.',
    'source' => 'Bron',
    'source_asset' => 'Bronasset',
    'held_duration' => 'Duur in tray',
    'warning_label' => 'Waarschuwing',
    'install' => 'Installeren',
    'needs_verification' => 'Controle nodig',
    'mark_destruction_pending' => 'Markeer voor vernietiging',
    'move_component_to_stock' => 'Component naar voorraad verplaatsen',
    'move_to_stock' => 'Naar voorraad',
    'move_to_tray' => 'Naar tray',
    'move_component_to_tray' => 'Component naar tray verplaatsen',
    'expected_component_stock_help' => 'Dit verwachte component wordt als gevolgd onderdeel aangemaakt en direct naar voorraad verplaatst. Je kunt later een specifieke opslaglocatie instellen op de componentdetailpagina.',
    'tracked_component_stock_help' => 'Verplaats dit gevolgde component uit het apparaat naar voorraad. Je kunt later een specifieke opslaglocatie instellen op de componentdetailpagina.',
    'tracked_component_stock_page_help' => 'Verplaats dit gevolgde component naar voorraad. Je kunt later een specifieke opslaglocatie instellen op de componentdetailpagina.',
    'move_component_into_stock_help' => 'Verplaats dit component nu naar voorraad. Je kunt later een specifieke opslaglocatie instellen op de componentdetailpagina.',
    'mark_component_in_stock_help' => 'Markeer dit component als in voorraad. Je kunt later op deze pagina een specifieke opslaglocatie instellen.',
    'mark_needs_verification_after_stock' => 'Markeer als controle nodig na verplaatsen naar voorraad',
    'confirm_move_to_stock' => 'Verplaatsing naar voorraad bevestigen',
    'confirm_to_stock' => 'Naar voorraad bevestigen',
    'confirm_in_stock' => 'In voorraad bevestigen',
    'remove_component_to_tray_help' => 'Verwijder dit component uit het huidige asset en plaats het in je tray.',
    'current_asset' => 'Huidig asset',
    'confirm_to_tray' => 'Naar tray bevestigen',
    'component_tag' => 'Componenttag',
    'component_actions_help' => 'Start de volgende workflow voor dit component met de knoppen hieronder.',
    'open_asset' => 'Asset openen',
    'unknown' => 'Onbekend',
    'aging' => 'Loopt op',
    'fresh' => 'Nieuw',
    'component_moved_to_tray' => 'Component naar tray verplaatst.',
    'component_installed' => 'Component geinstalleerd.',
    'component_moved_to_stock' => 'Component naar voorraad verplaatst.',
    'verification_required' => 'Controle nodig.',
    'verification_confirmed' => 'Controle bevestigd.',
    'component_marked_for_destruction' => 'Component gemarkeerd voor vernietiging.',
    'component_destroyed' => 'Component vernietigd.',
    'component_marked_damaged' => 'Component gemarkeerd als defect.',
    'only_tray_or_storage_components_installable' => 'Alleen tray- of opslagcomponenten kunnen via deze workflow worden geinstalleerd.',
    'component_created_and_installed' => 'Component aangemaakt en geinstalleerd.',
    'component_condition_updated' => 'Componentconditie bijgewerkt.',
    'choose_top_level_component_parent' => 'Kies een component op het hoogste niveau als parent.',
    'component_hierarchy_updated' => 'Componenthierarchie bijgewerkt.',
    'expected_component_moved_to_tray' => 'Verwacht component naar tray verplaatst.',
    'expected_component_moved_to_stock' => 'Verwacht component naar voorraad verplaatst.',
    'choose_different_destination_asset' => 'Kies een ander doelasset.',
    'component_moved_to_destination_asset' => 'Component naar het doelasset verplaatst.',
    'expected_component_moved_to_destination_asset' => 'Verwacht component naar het doelasset verplaatst.',
    'label_printer_queue_not_configured' => 'Labelprinterwachtrij is niet ingesteld. Stel LABEL_PRINTER_QUEUE in.',
