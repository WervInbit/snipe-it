...
тому що він не буде вам знову показаний.',
    ...
    'api_reference' => 'Будь ласка, перевірте <a href=":fork_documentation_url" target="_blank">довідку по API</a>, щоб дізнатись про ресурси API та додаткову документацію стосовно них.',
