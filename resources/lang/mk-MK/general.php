...
return [
    ...
    'importing'         	=> 'Увоз',
    'importing_help'        => 'Можете да увезувате средства, додатоци, лиценци, компоненти, потрошен материјали и корисници преку CSV -датотеката. <br><br>CSV треба да биде обележана со запирка и форматирана со заглавија што одговараат на оние во <a href=":fork_documentation_url" target="_new">пример на CSV во документацијата</a>.',
