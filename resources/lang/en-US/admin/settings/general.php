...
return [
    ...
    'ldap_runtime_disabled'     => 'LDAP is disabled for this environment and has not been validated for V1. Local accounts remain available. No directory connection will be attempted.',
...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can log in to this application. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code>, <code>true</code>, or any other text, the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
    ...
    'load_remote_help_text'		=> 'Uncheck this box if your installation cannot load scripts from the outside internet. This prevents the application from trying to load avatars from Gravatar or other outside sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a URL is provided here, users will be redirected to it after logging out of this application. This can close the user session at the authentication provider correctly.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if this installation is behind a VPN or closed network and users outside that network cannot load images served from it in their emails.',
    'site_name'                 => 'Site Name',
    ...
    'test_tooltips'             => 'Test Tooltips',
    'test_tooltips_help'        => 'JSON map of tooltip overrides for tests.',
    'snipe_version'  			=> 'Application version',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the support information and user manual links',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who sees the application version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to this application in emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not want email footers to link back to this application. This is useful if most recipients never log in.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This attempts to delete cached barcodes. It is typically used after barcode settings or the application URL changes. Barcodes will be regenerated when next accessed.',
    ...
    'download_public_certificate' => 'Public TLS certificate',
    'download_public_certificate_button' => 'Download certificate',
    'download_public_certificate_help' => 'Download the TLS certificate this instance presents so you can distribute it to managed devices.',
    ...
    'test_settings' => 'Workflow Settings',
    'test_settings_title' => 'Workflow Settings',
    'test_settings_help' => 'Manage workflow items, profiles, and instructions',
