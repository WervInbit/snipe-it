...
return [
    ...
    'importing_help'        => 'Вы можете импортировать активы, аксессуары, лицензии, компоненты, расходные материалы и пользователей через CSV-файл. <br><br>CSV должен быть разделен запятыми и отформатирован заголовками, которые соответствуют заголовкам <a href=":fork_documentation_url" target="_new">образца CSV в документации</a>.',
