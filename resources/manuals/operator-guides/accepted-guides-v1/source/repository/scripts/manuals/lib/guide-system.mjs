...
export const GUIDE_REGISTRY = Object.freeze({
    ...
    'AC-02': Object.freeze({ family: 'AC', title: 'Eigen wachtwoord wijzigen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    ...
    'AST-04': Object.freeze({ family: 'AST', title: 'Werk afronden en overdragen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    ...
    'CMP-02': Object.freeze({ family: 'CMP', title: 'Nieuw component registreren en plaatsen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    'CMP-04': Object.freeze({ family: 'CMP', title: 'Component naar tray verplaatsen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    ...
    'USR-04': Object.freeze({ family: 'USR', title: 'Gebruiker uitschakelen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    'USR-05': Object.freeze({ family: 'USR', title: 'Groepen beheren', status: GUIDE_STATUSES.WORKING_DRAFT }),
    'CAT-00': Object.freeze({ family: 'CAT', title: 'Catalogus begrijpen', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
    'CAT-01': Object.freeze({ family: 'CAT', title: 'Model en modelnummer aanmaken', status: GUIDE_STATUSES.INTERNAL_REVIEW }),
