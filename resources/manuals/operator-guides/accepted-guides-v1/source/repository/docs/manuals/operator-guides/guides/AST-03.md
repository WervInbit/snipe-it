...
| Field | Current value |
| --- | --- |
| Status | Internal review candidate; exact v15 accepted by owner 2026-09-10 |
| Family | AST |
| Type | Two-sided detail task |
| Current version | `AST-03-asset-registreren-en-labelen-v15-draft` |
...
| Generator | `scripts/manuals/generate-guide-followups.mjs AST-03`; use frozen round inputs to reproduce |
| Role | Supervisor |
...
The separate [v15 review](../reviews/AST-03-v15.md)
records the focused follow-up to baseline v14, with the exact
...
The owner accepted v15, selecting the unchanged PDF/hash in the
[v15 review](../reviews/AST-03-v15.md). The earlier candidate-pending
