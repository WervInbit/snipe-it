...
Status: replacement evidence captured; CAT-04 v3 uses four replacement states
in a separate unaccepted audit pilot. CAT-03 and CMP-02 regeneration remains
pending. Neither simulated overlap capture is used by CAT-04 v3; see its
[review record](CAT-04-v3.md).
