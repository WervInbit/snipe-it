...
## Latest Owner Review - 2026-09-10

USR-04 v5 is **explicitly not accepted**. The owner requests a scope/flow
redesign and removal of check-in work and the top delete/restore OR route.
The recommendation is a single disable-login task, with deletion/restoration
scoped separately. That split is proposed, not yet generated or registered.
See [MR-09](../reviews/owner-review-todos-2026-09-10.md). The v3 baseline and
its specification below are retained history, not an accepted replacement.

Separate comparison proposal: [USR-04 v4](../reviews/USR-04-v4.md) is retained
after the owner rejected the batch's design direction. The selected baseline
below remains unchanged. Individual factual corrections remain undecided;
follow the [feedback](../reviews/2026-09-08-pilot-direction-feedback.md) before revising.
...
The separate [v5 review](../reviews/USR-04-v5.md)
