...
current=json.loads((ROUND/f'current-guide-selection-v{VERSION-1}.json').read_text())['guides']
...
report={'bundleVersion':VERSION,'createdOn':'2026-09-10',
        ...
        'currentSelection':f'{8 if VERSION==3 else 10} owner-correction candidates; 47 pages.',
