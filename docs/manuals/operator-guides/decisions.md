...
| CAT-00 | v4 draft | Complete mental-model rewrite; awaiting exact-version review | 2026-08-25 | Eight-page reference chapter covering identities, reusable attribute and component definitions, model-number baselines, physical asset state, effective-value precedence, and explicit CAT-01 through CAT-06 routes. |
| CAT-01 | v2 draft | Cold-start pass; awaiting exact-version review | 2026-08-20 | Supervisor procedure using the current `Instellingen > Asset modellen` route, Basismodel terminology, exact manufacturer codes, and a CAT-02 handoff. |
