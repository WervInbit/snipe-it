...
| Will the Dutch UI label change from `Asset modellen` to `Basismodellen` before new CAT evidence is captured? | Before CAT-00 v8/CAT-01 v4 evidence is frozen; a later UI rename creates new guide versions. |
...
| CAT-00 | v8 draft | Six-part orientation rebuild; awaiting exact-version review | 2026-09-01 | Implements the CAT family plan as an overview and router: identity, reusable definitions, expected/physical state, specification placement, and follow-up ownership without teaching every task form. |
| CAT-01 | v4 draft | Global-search and family-plan correction; awaiting exact-version review | 2026-09-01 | Retains the three-route creation flow, adds recognizable dashboard navigation and global exact-code search evidence, and verifies the complete saved identity before CAT-02/AST-03 handoff. |
| CAT-02 | planned | Specification alignment and evidence pending | 2026-09-01 | Ordinary Supervisor specification setup: direct attributes, expected components, calculated-spec behavior, overlap prevention, Save, and final verification. Saved-row cleanup routes to CAT-05. |
...
| CAT-04 | v1 draft | Working draft; awaiting exact-version review | 2026-09-01 | Six-page reusable-definition flow with identity, expected parts, attribute contributions, hierarchy-overlap correction, Save, and reuse routes. Browser-inaccessible tracking/placement controls remain excluded. |
